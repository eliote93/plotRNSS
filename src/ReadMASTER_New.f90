...
DO
  ...
  SELECT CASE (oneline(11:Lgh))
  CASE ('MAXIMUM PIN AND FA 3-D POWER DISTRIBUTIONS') ! 3-D
    DO itmp = 1, 14
      READ (indev, *)
    END DO
  ...
  CASE ('1-D POWER DISTRIBUTIONS') ! 1-D
    DO itmp = 1, 8
      READ (indev, *)
    END DO
...
DO
  ...
  SELECT CASE (oneline(11:Lgh))
  CASE ('AXIALLY AVERAGED MAXIMUM PIN AND FA POWER DISTRIBUTIONS') ! 2-D
    DO itmp = 1, 14
      READ (indev, *)
    END DO
